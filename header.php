      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="amenord.php">Amérique du Nord</a>
			<a class="dropdown-item" href="amesud.php">Amérique du Sud</a>
            <a class="dropdown-item" href="index.php">Asie</a>
			<a class="dropdown-item" href="afrique.php">Afrique</a>
			<a class="dropdown-item" href="oceanie.php">Océanie</a>
			<a class="dropdown-item" href="anta.php">Antarctique</a>
          </div>
        </li>
      </ul>
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="authentification.php">Se connecter</a>
        </li>
        <li class="nav-item">
